...
float4 CalculateLight(LightMaterial material)
{
    float4 color = 0;
...
struct GBufferOutput
{
    ...
    float4  embient : SV_TARGET3;
    float4 emissive : SV_TARGET4;
};

GBufferOutput PackBuffer(float3 baseColor, float3 normal, float specularIntensity, float4 ambient)
{
