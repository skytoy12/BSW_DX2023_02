...
CHulOutput CHS(InputPatch<VertexTexture, NUM_CONTROL_POINTS> input)
{
    CHulOutput output;
...
HullOutput main(InputPatch<VertexTexture, NUM_CONTROL_POINTS> input, uint i : SV_OutputControlPointID)
{
    HullOutput output;
