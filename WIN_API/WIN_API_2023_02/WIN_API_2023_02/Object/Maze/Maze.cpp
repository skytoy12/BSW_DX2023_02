...
void Maze::CreateMaze()
{
	...
	for (int y = 0; y < _poolCountY; ++y)
	{
		for (int x = 0; x < _poolCountX; ++x)
		{
			...
			// 랜덤으로 우측 혹은 아래로만 뚫었을 때 길이 안생기는것 예처리
			if (y == _poolCountY - 2)
			{
...
MazeBlock::BlockType Maze::GetBloockType(int y, int x)
{
